...
public class JeVoisInterface {
    ...
    public void setCameraStreamActive(boolean active){
        if(dataStreamRunning == false){
            ...
            DriverStation.reportError("Attempt to change cam stream mode while JeVois is still running. This is disallowed.", false);
        }
...
//        sendCmdAndCheck("streamoff");
        sendCmdAndCheck("setpar serstyle Detail");
        sendCmdAndCheck("setpar serstamp Frame");
//        sendCmdAndCheck("setmapping " + Integer.toString(20));
 //       sendCmdAndCheck("setmapping2 NONE 0 0 0.0 YUYV 320 240 60.0 JeVois ObjectTracker");
//        sendCmdAndCheck("setmapping2 YUVY 320 254 60.0 YUYV 320 240 60.0 JeVois ObjectTracker");
//        sendCmdAndCheck("setpar serout USB");
//         sendCmdAndCheck("streamon");
        //(rmr662) hopefully tells jevois to send data
 //       sendCmdAndCheck("setpar serlog USB");
        ...
        if (visionPort != null){
            while(Timer.getFPGATimestamp() - startTime < timeout_s){
                ...
                if (visionPort.getBytesReceived() > 0) {
                    ...
                    //Should output number of bytes received (rmr662)
                    System.out.println("Recieved:" + visionPort.getBytesReceived());
                    //System.out.println("Data: " + visionPort.readString());
